...
def attack(char_name: str, char_class: str) -> str:
    """В зависимости от выбора класса, какой урон будет нанесен противнику."""
...
def defence(char_name: str, char_class: str) -> str:
    """В зависимости от выбора класса, сколько урона будет блокировано."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Каждый класс персонажей имеет свои умениия."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Создание персонажа, ввод имени, выбор класса."""
    approve_choice = None
    char_class = None
